  ...
  context('when assessment is of type CERTIFICATION', function () {
    ...
    context('when scoring is successful', function () {
      ...
      beforeEach(function () {
        ...
        competenceMarkData1 = domainBuilder.buildCompetenceMark({ assessmentResultId, score: 5 });
        competenceMarkData2 = domainBuilder.buildCompetenceMark({ assessmentResultId, score: 4 });
